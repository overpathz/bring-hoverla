...
public class StringConstants {
    ...
    //Error messages
    public final static String BEAN_CLASS_ERROR_MESSAGE = "Bean class cannot be null";
    public final static String CONFIGURATION_CLASS_INSTANCE_ERROR_MESSAGE = "Configuration class instance can't be null";
    public final static String CONFIGURATION_BEAN_METHOD_ERROR_MESSAGE = "Configuration bean method can't be null";

    //Error from Reflection API
    //Create messages to give more detail about throwing exception from Reflection library
    public final static String CAN_NOT_GET_FIELD = "Can not get field: %s by instance: %s";
    public final static String CAN_NOT_SET_FIELD = "Can not set field: %s by instance: %s";
    public final static String CAN_NOT_CREATE_INSTANCE = "Can not create instance for constructor: %s";
    public final static String CAN_NOT_CREATE_INSTANCE_WITH_ARGUMENTS = "Can not create instance for constructor: %s with arguments: %s";
    ...
    public final static String INVOKE_METHOD_EXCEPTION = "Can't invoke '%s' method";

    //InitializePropertyException
    ...
    public static String BEAN_INSTANCE_CREATION_EXCEPTION = "Bean with name '%s' can't be instantiated";
    public static String BEAN_INSTANCE_CREATION_SAME_CANDIDATE_EXCEPTION = "Bean named `%s` has a supertype and one of its subtypes" +
